...
public class VehicleSerializationHandlerTests {
    private VehicleSerializationHandler handler;
    private File tempFile;
    private List<Vehicle> vehicles;

    @BeforeEach
    void setUp() throws IOException {
        handler = new VehicleSerializationHandler();
        tempFile = File.createTempFile("vehicles", ".dat");
    ...
    @Test
    void testWrite_shouldWriteVehiclesToFile() throws IOException {
    ...
    @Test
    void testRead_shouldReadVehiclesFromFile() throws IOException {
        handler.write(vehicles, tempFile.getPath());
